...
class Region(SeqFeature):
    ...
    def __init__(self, chrom, location=None, score=0, strand=0,
        type="Region", id="NA", qualifiers=None, profile=None):
    ...
    def __str__(self):
        ...
        return "{}\t{}\t{}\t{}\t{}\t{}".format(self.chrom, self.start,
            self.end, self.id, self.score, self.strand_format)

    def __repr__(self):
        return "<{}(chrom={}, start={}, end={}, id={}, score={}, strand={})>".format(self.type,
            self.chrom, self.start, self.end, self.id, self.score, self.strand_format)
    ...
    def overlap(self, region):
        """
        If region overlaps this one, return True;
        ...
        if region:
            ...
            # -----22222--------------- => False
            # ---------------22222----- => False
            if self.chrom == region.chrom and self.start < region.end and self.end > region.start:
                return True
