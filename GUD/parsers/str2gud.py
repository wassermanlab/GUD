...
optional arguments:
  ...
  --dummy-dir DIR     dummy directory (default = "/tmp/")                      ## TODO remove
  -m, --merge         merge genomic regions using bedtools                     ## TODO remove 
                      (default = False)
...
def parse_args():
    ...
    # optional_group.add_argument("--dummy-dir", default="/tmp/")               TODO remove
...
def str_to_gud(genome, source_name, str_file, based, test=False, threads=1):
    ...
    global Session
    global source
    # set_tempdir(dummy_dir) # i.e. for pyBedTools                              TODO remove
